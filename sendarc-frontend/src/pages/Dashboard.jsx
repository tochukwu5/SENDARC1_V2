        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-[#8892a0] text-sm mt-1">
              Welcome back — here's your transfer activity
              {backendOnline && (
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/send"
              className="bg-[#00D4FF] text-[#0D1117] font-['Space_Grotesk'] font-bold px-5 py-2.5 rounded-xl hover:opacity-90 transition-all text-sm"
            >
              + Send Money
            </Link>
          </div>
                ...
                <div key={c.name}>
                  <div className="flex justify-between text-sm mb-1.5">
                    <span className="flex items-center gap-2">
                      <span>{c.flag}</span>
                      <span className="text-white font-['Space_Grotesk'] font-semibold">{c.name}</span>
                    </span>
                  ...
                  {testnetTxs.slice(0, 5).map(tx => (
                    <tr key={tx.id || tx._id} className="border-b border-[#0f1520] hover:bg-[#0f1822] transition-colors">
                      <td className="px-5 py-4">
                        ...
                        <p className="text-[10px] text-[#556]">Arc Testnet</p>
                      </td>
          ...
          <div className="mt-4 bg-[#0a2030] border border-[#00D4FF]/30 rounded-xl p-4 flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-[#8892a0]">
                Send your first USDC transaction on Arc Testnet — stats will appear here from MongoDB.
              </p>
            </div>
            <Link
              to="/testnet"
