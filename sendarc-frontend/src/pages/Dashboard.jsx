...
export default function Dashboard() {
  ...
  const { stats: testnetStats, transactions: testnetTxs } = useTestnet()
  const navigate = useNavigate()
    ...
    <div className="flex min-h-screen bg-[#0D1117]">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <Link to="/testnet/send" className="border border-[#00D4FF] text-[#00D4FF] font-['Space_Grotesk'] font-bold px-4 py-2.5 rounded-xl hover:bg-[#0a2030] transition-all text-sm mr-2">
                ⚡ Testnet
              </Link>
